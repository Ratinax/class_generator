...
void	createCpp(std::string name, int is_color)
{
	...
	myOutFile << "{" << std::endl;
	if (is_color != 0)
		putMessage(myOutFile, name, "copy assignment operator called", "BLACK");
	else
		putMessage(myOutFile, name, "copy assignment operator called");
...
void	createHpp(std::string name, int is_color)
{
	...
	if (is_color)
	{
		...
		myOutFile << "# define BLACK			\"\\033[0m\\033[30m\"" << std::endl;
		myOutFile << "# define RED			\"\\033[0m\\033[31m\"" << std::endl;
		myOutFile << "# define GREEN			\"\\033[0m\\033[32m\"" << std::endl;
		myOutFile << "# define YELLOW			\"\\033[0m\\033[33m\"" << std::endl;
		myOutFile << "# define BLUE			\"\\033[0m\\033[34m\"" << std::endl;
		myOutFile << "# define MAGENTA		\"\\033[0m\\033[35m\"" << std::endl;
		myOutFile << "# define CYAN			\"\\033[0m\\033[36m\"" << std::endl;
		myOutFile << "# define WHITE			\"\\033[0m\\033[37m\"" << std::endl;
